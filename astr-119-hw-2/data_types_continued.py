...
print(type(alpha_tuple))		#will sat tuple

try:							#attempt the following line
	alpha_tuple[2] = "d"		#won't work and will raise TypeError
except TypeError:				#esception for the Type Error
	print("We can't ass elements to tuples!") 		#print the message
